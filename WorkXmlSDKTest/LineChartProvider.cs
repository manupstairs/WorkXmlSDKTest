...
{
    public static class LineChartProvider
    {
        public static Drawing CreateLineChart(WordprocessingDocument doc)
        {
            ...
            var lineSeries = new LineChartSeries(
                ...
                new Order() { Val = 0U },
                new SeriesText(new NumericValue() { Text = "Êý¾Ý" })
            );
            ...
            var cat = new CategoryAxisData(
                new StringLiteral(
                    ...
                    new StringPoint() { Index = 0U, NumericValue = new NumericValue("A") },
                    new StringPoint() { Index = 1U, NumericValue = new NumericValue("B") },
                    new StringPoint() { Index = 2U, NumericValue = new NumericValue("C") }
                )
            );
            ...
            var val = new Values(
                new NumberLiteral(
                    ...
                    new NumericPoint() { Index = 2U, NumericValue = new NumericValue("15") }
                )
            );

            lineSeries.Append(cat);
            lineSeries.Append(val);
            lineChart.Append(lineSeries);

            // Axis IDs (must be unique and cross-referenced)
            ...
            var drawing = new Drawing(
                new DocumentFormat.OpenXml.Drawing.Wordprocessing.Inline(
                    ...
                    new DocumentFormat.OpenXml.Drawing.Wordprocessing.DocProperties() { Id = 1U, Name = "Line Chart" },
