...
{
    public static class BarChartProvider
    {
        public static Drawing CreateBarChart(WordprocessingDocument doc)
        {
            ...
            barSeries.Append(cat);
            barSeries.Append(val);
            ...
            var drawing = new Drawing(
                new DocumentFormat.OpenXml.Drawing.Wordprocessing.Inline(
                    ...
                    new DocumentFormat.OpenXml.Drawing.Wordprocessing.DocProperties() { Id = 1U, Name = "Bar Chart" },
